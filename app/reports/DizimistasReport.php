...
class DizimistasReport
{
    ...
    public function gerar(array $filtros): string
    {
        ...
        /* =======================
           TEMPLATE
        ======================== */
        $templatePath = BASE_PATH . '/uploads/reports/Resumo_Geral_de_Dizimistas.xlsx';
        ...
        $sql = "
            ...
            WHERE (:ini IS NULL OR d.data >= :ini)
              AND (:fim IS NULL OR d.data <= :fim)
            ORDER BY d.data ASC
        ";
        ...
        /* =======================
           SALVAR
        ======================== */
        $arquivo = 'Resumo_Geral_de_Dizimistas_' . time() . '.xlsx';
